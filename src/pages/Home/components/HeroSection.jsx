...
const HeroSection = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row px-5 md:mt-40 md:mb-45 md:px-12 items-center justify-between flex-grow container mx-auto relative overflow-hidden">
